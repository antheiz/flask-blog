...
from .forms import LoginForm, RegisterForm, AccountForm, PostForm, RequestResetForm, ResetPasswordForm
...
def reset_token(token):
    ...
    if user is None:
        flash('Link ini sudah expired, Silakan mengulang', 'warning')
